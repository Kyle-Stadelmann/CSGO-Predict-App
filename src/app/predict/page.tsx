            ...
            <CardHeader>
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                  ...
                  <CardDescription>Select the 8 teams that will make it to the playoffs</CardDescription>
                </div>
                ...
                {isPlayoffLocked ? (
                  <Alert variant="destructive" className="sm:w-auto max-w-md">
                    ...
                    <AlertDescription>The deadline for playoff predictions has passed</AlertDescription>
                  </Alert>
                ) : (
                  <Alert className="sm:w-auto max-w-md">
                    ...
                    <AlertDescription>
                      {daysRemaining > 0 ? (
                        <>
                          {daysRemaining} day{daysRemaining !== 1 ? "s" : ""} and {hoursRemaining} hour
