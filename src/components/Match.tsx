        ...
        <div className="match">
            ...
            <div className="team-container">
                ...
                <div className="team left">
                    <Team id={team1.id} name={team1.name} logoUrl={team1.logo_url} country={team1.country} rank={team1.rank} onClick={handleTeam1Picked} />
                </div>
                <div className="team right">
                    <Team id={team2.id} name={team2.name} logoUrl={team2.logo_url} country={team2.country} rank={team2.rank} onClick={handleTeam2Picked} />
                </div>
            </div>
            &nbsp;
